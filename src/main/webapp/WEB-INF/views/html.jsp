     ...
     <div id="content">
        	...
        	<div id="myCarousel" class="carousel slide" data-ride="carousel">
			  ...
			  <div class="carousel-inner">
			    <div class="item active">
			      <img src="${pageContext.request.contextPath}/resources/images/html/0.jpg">
			    </div>
			
			    <div class="item">
			      <img src="${pageContext.request.contextPath}/resources/images/html/1.jpg">
			    </div>
			  </div>
		...
		<div class="contentBottom">
			<ul class="list-group" id="exUl">
			  ...
			  <li class="list-group-item">HTML, CSS(개인 프로젝트)</li>
			  <li class="list-group-item">프로젝트 명: TOUR PLAN</li>
			  <li class="list-group-item">작업 기간: 2017.08</li>
			  <li class="list-group-item">개발 도구: Eclipse, HTML, CSS</li>
			  <li class="list-group-item color">프로젝트 설명</li>
			  <li class="list-group-item">
			  	HTML과 CSS을 이용하여 가상 여행 홈페이지의 메인을 구현(반응형으로 제작)  
			  </li>
			  <li class="list-group-item color">관련 링크</li>
			  <li class="list-group-item">
			  	<a href="http://skykim10908.dothome.co.kr/Travel.html" target="blank">HTML & CSS(링크만료)</a><br>
			  </li>
